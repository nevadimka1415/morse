...
public static class MauiProgram
{
    public static MauiApp CreateMauiApp()
    {
        ...
        builder.Services.AddSingleton<IMicrophoneStream, Platforms.Android.PlatformMicrophoneStream>();
        ...
        builder.Services.AddSingleton<IMicrophoneStream, Platforms.iOS.PlatformMicrophoneStream>();
