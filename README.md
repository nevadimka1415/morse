...
- записи пользователя можно сделать стандартным голосом приложения для всех: `scripts/import-voice.sh <папка>` обрезает тишину, выравнивает громкость и кладёт WAV для Windows и m4a для телефона;
