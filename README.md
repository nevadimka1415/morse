...
- записи пользователя можно сделать стандартным голосом приложения для всех: `scripts/import-voice.py <папка>` находит напев по громкости, обрезает тишину и щелчки по краям, выравнивает громкость и кладёт WAV для Windows и m4a для телефона; с версии 2.6.1 русские буквы звучат голосом живого человека;
