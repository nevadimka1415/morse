...
- экзамен: задание с текущими параметрами, одно прослушивание, ответ скрыт, идёт время; после проверки — протокол (точность, ошибки по символам, позиции, время) с сохранением в TXT на Windows и «Поделиться» на телефоне, запись в истории с пометкой «экзамен»;
