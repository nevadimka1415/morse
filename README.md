...
- курс «С нуля до 60 зн/мин» на вкладке «Обучение» (Windows и телефон): метод Коха по 4 новых символа на шаг, слова на 50 и 60 зн/мин, итоговый экзамен; «Начать курс» сначала раскрывает книжку — как устроен курс, метод Коха, скорость и паузы, путь по шагам, как заниматься (можно пропустить, перечитать — «📖 Как устроен курс»); «Начать шаг» ставит нужные настройки и создаёт задание, шаг засчитывается при точности от 90 %, «Следующий шаг» открывается после зачёта; задания курса помечаются в истории;
- во время прослушивания задания крупно видно «Группа 3 из 10», а звучащая группа подсвечена в тексте задания — на бумаге не сбиться;
